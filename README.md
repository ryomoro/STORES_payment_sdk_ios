...
## お知らせ
### 2022−07−08 : STORES Payments SDK 公開のお知らせ
タッチ決済に対応した新しい SDK `STORES Payments SDK` をリリースしました。
詳しくは[こちら](https://github.com/Coiney-SDK/STORESPaymentsSDK-iOS)をご覧ください。

※今後の新機能追加に関しましては、新しい `STORES Payments SDK` にて行う方針としておりますので、引き続きご利用いただく場合は、新しい SDK への移行をご検討ください
